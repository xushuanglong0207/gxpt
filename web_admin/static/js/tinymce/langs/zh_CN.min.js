tinymce.addI18n('zh_CN',{
    ...
    "Close": "关闭",
    "Formats": "格式",
    "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.": "你的浏览器不支持直接访问剪贴板，请使用Ctrl+X/C/V键盘快捷键代替。",
    "Headers": "标题",
    "Header 1": "标题1",
    "Header 2": "标题2",
    "Header 3": "标题3",
    ...
    "Name": "名称",
    "Id": "id",
    "Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.": "ID应该以字母开头，后面只能跟字母、数字、破折号、点、冒号或下划线。",
    ...
    "Paste your embed code below:": "将你的嵌入代码粘贴在下面:",
    "Embed": "嵌入",
    "Media...": "媒体...",
...
function saveArticle() {
    ...
    // 同时保存到本地存储，作为备份
    saveArticleToLocalStorage(currentArticleId, content);
    
    // 发送保存请求
    fetch(`/api/knowledge/article/${currentArticleId}`, {
        method: 'PUT',
        headers: {
